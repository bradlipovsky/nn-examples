function u0 = ssainit(p,x,drivestress,gamma,initchoice,Q)
% SSAINIT  Computes the initial guess velocity u0, used in
% SSAFLOWLINE to solve the SSA flow line stress balance.
% form
...
elseif initchoice == 4
  % frictional
  u0 = exp(-Q/p.a + drivestress/p.sig/p.a) * p.u0;
else, error('initchoice must be 1,2,3,4'), end
